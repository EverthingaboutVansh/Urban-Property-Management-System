...
public class HomeScreenGUI extends JFrame {
    //JMenu fileMenu, landlordsMenu, propertiesMenu, tenantsMenu, rentalsMenu, helpMenu; will be used as a reference for the navigation:
    ...
    public static void main(String args[]) throws IOException {
        ...
        //Navigation of main file to another files OR Now From Login
        Login l=new Login();
        l.setVisible(true);
    ...
    public HomeScreenGUI() {
        ...
        Image storeImage = Toolkit.getDefaultToolkit().createImage("images/PropertyManagement 2.1.png"); 
    ...
    private void createMenuBar() {
        ...
        exit.addActionListener(ae -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                saveDatabases();
                JOptionPane.showMessageDialog(null, "Database updated. Thank  You For Visiting");
        ...
        //navigation back to Login page ?try if it work
        /*
        HomeScreenGUI ex = new HomeScreenGUI();
        ex.setVisible(true);
        */
